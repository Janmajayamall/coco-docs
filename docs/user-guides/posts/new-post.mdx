...
The other half of the Creation Value is used to buy YES outcome shares for yourself,
...
_We recommend a Creation Value of `0.01 - 0.1 WETH` while on Testnet, just so
that you can experience the fun of using COCO._
